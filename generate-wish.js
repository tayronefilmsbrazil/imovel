// Script Node: gera index.html do Wish Residence usando template.js
global.window = {};
require('./template.js');
const fs = require('fs');
...
const data = {
  ...
  features: [
    {
      icon: '🌊',
      title: 'Localização premium na Jatiúca',
      desc: '1ª quadra da Praia da Jatiúca, a cerca de 100 metros do mar. Bairro mais valorizado de Maceió, cercado por restaurantes, cafés, academias e supermercados. Maceió Shopping a 5 minutos e Corredor Vera Arruda próximo.',
    },
    {
      icon: '🏢',
      title: 'Rooftop completo com vista mar',
      desc: 'Piscina adulto e infantil, deck molhado, espaço gourmet, forno de pizza, academia, coworking, salão de jogos, mega lounge e salão de festas — tudo no rooftop com vista para a Praia da Jatiúca.',
    },
    {
      icon: '✨',
      title: 'Novo, pronto para morar, nunca habitado',
      desc: 'Construção V2 Construções. 78,58m² úteis, 2 quartos (1 suíte), varanda gourmet, 1 a 2 vagas. Aceita financiamento bancário. Documentação em dia.',
    },
  ],
...
const html = global.window.LandingTemplate.generateLandingPage(data);
fs.writeFileSync('index.html', html);
console.log('index.html gerado. Tamanho:', (html.length / 1024).toFixed(1), 'KB');
